...
`;
    ...
    const insertedProducts = await Promise.all(
      products.map(
        (product) => client.sql`
        INSERT INTO products (product_id, name, description, image_url, user_id, category)
        VALUES (${product.product_id}, ${product.name}, ${product.description}, ${product.image_url}, ${product.user_id}, ${product.category})
